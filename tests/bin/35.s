...
MAKE_CLOSURE(rax, SOB_NIL_ADDRESS, Lcode144)
jmp Lcont144
Lcode144:
push rbp
mov rbp, rsp
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop145
simple_param_loop145:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop145
simple_param_end_loop145:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop146
simple_param_loop146:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop146
simple_param_end_loop146:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop147
simple_param_loop147:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop147
simple_param_end_loop147:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop148
simple_param_loop148:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop148
simple_param_end_loop148:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop149
simple_param_loop149:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop149
simple_param_end_loop149:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop150
simple_param_loop150:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop150
simple_param_end_loop150:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop151
simple_param_loop151:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop151
simple_param_end_loop151:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop152
simple_param_loop152:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop152
simple_param_end_loop152:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop153
simple_param_loop153:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop153
simple_param_end_loop153:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop154
simple_param_loop154:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop154
simple_param_end_loop154:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop155
simple_param_loop155:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop155
simple_param_end_loop155:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop156
simple_param_loop156:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop156
simple_param_end_loop156:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop157
simple_param_loop157:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop157
simple_param_end_loop157:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop158
simple_param_loop158:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop158
simple_param_end_loop158:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop159
simple_param_loop159:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop159
simple_param_end_loop159:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop160
simple_param_loop160:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop160
simple_param_end_loop160:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop161
simple_param_loop161:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop161
simple_param_end_loop161:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop162
simple_param_loop162:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop162
simple_param_end_loop162:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop163
simple_param_loop163:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop163
simple_param_end_loop163:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop164
simple_param_loop164:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop164
simple_param_end_loop164:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop165
simple_param_loop165:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop165
simple_param_end_loop165:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop166
simple_param_loop166:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop166
simple_param_end_loop166:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop167
simple_param_loop167:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop167
simple_param_end_loop167:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop168
simple_param_loop168:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop168
simple_param_end_loop168:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop169
simple_param_loop169:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop169
simple_param_end_loop169:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
mov rcx, 0 ; rcx is the loop var, r11 is the limit, doing the exchange using r14
cmp r11, 0 ; there is no parameters
je simple_param_end_loop170
simple_param_loop170:
mov r14, PVAR(rcx)
mov qword [rdx + 8*(rcx)], r14
inc rcx
cmp rcx, r11
jne simple_param_loop170
simple_param_end_loop170:
mov qword [rbx], rdx ; put this env in ExtEnv[0]
...
MAKE_CLOSURE(rax, SOB_NIL_ADDRESS, Lcode171)
jmp Lcont171
Lcode171:
push rbp
mov rbp, rsp
